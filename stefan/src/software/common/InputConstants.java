...
public class InputConstants {
	...
	public static byte[] C = "Demo Ben Ward 4 ".getBytes();	
	
	/*
	//GWU Nov 4 mock election
	public static byte[] MK1 = "+}l25$004Da61ggg".getBytes();
	public static byte[] MK2 = "Rmp690^p-vB`$SSZ".getBytes();
	public static byte[] C = "GWU Nov 4th mock".getBytes();		
	 */
