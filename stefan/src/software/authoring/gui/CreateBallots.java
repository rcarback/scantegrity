...
/*				
				if (InputConstants.FrontEnd.equals(InputConstants.BallotType.SCANTEGRITY_II)) {
			    	software.authoring.scantegrity.PrintableBallotMaker pbm=new software.authoring.scantegrity.PrintableBallotMaker(this.electionSpec,this.geometry);
			    	pbm.init(background,this.printsFilePath);
					...
					if (InputConstants.FrontEnd.equals(InputConstants.BallotType.PUNCHSCAN)) {
				    	software.authoring.PrintableBallotMaker pbm=new software.authoring.PrintableBallotMaker(this.electionSpec,this.geometry);
				    	pbm.init(background,this.printsFilePath);
