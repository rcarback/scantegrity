...
public class FillInPdfForm {
	...
	public static void main(String[] args) throws Exception {
		...
		FillInPdfForm.fillIn(es, dir+"javaCreatedForm.pdf",InputConstants.privateFolder+"MeetingTwoPrints.xml",range,software.authoring.ContestSymbols.alphabet,false,dir);		
	}
