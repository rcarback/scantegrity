...
//System.out.println(possition.left());		
		cb.saveState();
		...
		try {
            ...
            jpg.scaleAbsolute(possition.width(), possition.height());
	...
	public void addTextField(Rectangle possition, String name, BaseFont font, int fontSize,String defaultText) {
		...
		cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "Enter Code:",possition.left()-200,possition.bottom(),0);
		cb.endText();
		
		TextField tf = new TextField(writer, new Rectangle(possition.left(),possition.bottom(),possition.right(),possition.top()), "vote");
        ...
        //add the cast button
        possition.setBottom(possition.bottom()-100);
        possition.setTop(possition.top()-100);
