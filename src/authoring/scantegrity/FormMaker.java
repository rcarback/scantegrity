...
public class FormMaker extends software.authoring.FormMaker {
...
*/        
    ...
    public static Rectangle translate(Rectangle rect,float tx,float ty) {
    	float fromx=rect.left()+tx;
    	float fromy=rect.bottom()+ty;
    	float tox=rect.right()+tx;
    	float toy=rect.top()+ty;
