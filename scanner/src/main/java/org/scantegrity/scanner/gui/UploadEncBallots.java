				...
				}
				{
					...
					jButtonUpload.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							...
							org.scantegrity.scanner.UploadEncBallots u = null;
							try {
								u = new org.scantegrity.scanner.UploadEncBallots(new String(jPasswordField1.getPassword()),jTextFieldURL.getText());
