...
import org.scantegrity.engine.RowPermutation;
...
*/
	...
	protected void computeR(Prow prow,Rrow rrow,byte partitionId) throws Exception {		
		rrow.setVote(markPerm.computeD3(prow.getVote(),markPerm.compose(prow.getPage2(),markPerm.getInversePartition(prow.getPage1(),partitionId),partitionId), partitionId));
	}
