 ...
 * @author  rick
 */
public class EnterPasswords extends javax.swing.JFrame {
    ...
    public EnterPasswords(int meeting, ElectionDataHandler handler, PunchscanLive parent) throws SAXException, IOException {
        passwordList = new Vector<String>();
        userList = new Vector<String>();
